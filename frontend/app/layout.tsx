  ...
  return (
    <html lang="en" className={cn("light", inter.variable, manrope.variable)}>
      ...
      <body className="min-h-full flex flex-col bg-background text-on-surface font-body selection:bg-primary-container selection:text-on-primary-container">
        ...
        {/* Main content */}
        <main className="flex-1 w-full pt-16 md:pt-24 pb-12 md:pb-24">{children}</main>

        {/* Footer Shell */}
        <footer className="bg-slate-50 dark:bg-slate-950 w-full py-8 md:py-12 mt-auto">
          <div className="flex flex-col md:flex-row justify-between items-center px-4 md:px-6 lg:px-12 max-w-screen-2xl mx-auto">
            <div className="font-headline font-bold text-slate-900 dark:text-slate-100 mb-6 md:mb-0 text-xl">
              RentersGuard
            </div>
            <div className="flex flex-wrap justify-center gap-4 md:gap-8 text-xs md:text-sm font-['Inter'] tracking-wide">
              <Link
